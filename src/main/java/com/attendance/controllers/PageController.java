...
public class PageController {
	...
	public int addCategory(@RequestParam("category") String category,@RequestParam("days") String days,@RequestParam("emptype") String empType) {
	...
	public int addLeaveArrears(@RequestParam("staff") String staffid,@RequestParam("days") String days,@RequestParam("year") String year) {
