...
public class OvertimeRepository {
	...
	public int saveOvertime(long id,String dept,String reason,String date,String starttime,String entime ) {
		...
		return template.update(sql, reason,id,dept,date,starttime,entime,entime,starttime);
	...
	public List<Overtime> getOvertimes(long id){
		...
		for(Overtime ot : overtimes) {
			ot.setStaff(staffRepository.getStaffByID(ot.getStaffId()));
	...
	public List<Overtime> getOvertimesDeptApproved(int dept,String start,String end){
