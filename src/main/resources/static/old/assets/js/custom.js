...
$.ajax({
    ...
    success: function(datas) {
      ...
      SimpleJekyllSearch.init({
    	    ...
    	    dataSource: staff,
    	    searchResultTemplate: '<li><div class="link"><a href="/attendance/admin/profile?id={bioID}">{name}</a></div><div class="location">{department}</div><\/li>',
